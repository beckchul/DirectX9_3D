...
void Engine::CCubeColor::SetBoundingBox(const D3DXVECTOR3* pMin
	...
	, const DWORD& dwColor)
{
	...
	pVertex[0].vPos = D3DXVECTOR3(pMin->x, pMax->y, pMin->z);
	pVertex[1].vPos = D3DXVECTOR3(pMax->x, pMax->y, pMin->z);
	pVertex[2].vPos = D3DXVECTOR3(pMax->x, pMin->y, pMin->z);
	pVertex[3].vPos = D3DXVECTOR3(pMin->x, pMin->y, pMin->z);

	pVertex[4].vPos = D3DXVECTOR3(pMin->x, pMax->y, pMax->z);
	pVertex[5].vPos = D3DXVECTOR3(pMax->x, pMax->y, pMax->z);
	pVertex[6].vPos = D3DXVECTOR3(pMax->x, pMin->y, pMax->z);
	pVertex[7].vPos = D3DXVECTOR3(pMin->x, pMin->y, pMax->z);
...
void Engine::CCubeColor::Render(const D3DXMATRIX* pmatWorld)
{
	m_pDevice->SetTexture(0, NULL);
	m_pDevice->SetRenderState(D3DRS_LIGHTING, FALSE);
	m_pDevice->SetRenderState(D3DRS_FILLMODE, D3DFILL_WIREFRAME);
	CVIBuffer::Render(pmatWorld);
