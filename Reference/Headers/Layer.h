...
public:
	const CComponent* GetComponent(const TCHAR* pObjectKey,  const TCHAR* pComponentKey);
	const list<CGameObject*>  GetGameObjectlist(const TCHAR* pObjectKey);
	list<CGameObject*>  GetNotConstGameObjectlist(const TCHAR* pObjectKey);
public:
