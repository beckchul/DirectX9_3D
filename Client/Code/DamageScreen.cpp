...
CDamageScreen::CDamageScreen(LPDIRECT3DDEVICE9 pDevice)
...
CDamageScreen::~CDamageScreen(void)
{

}

HRESULT CDamageScreen::Initialize(void)
{
...
void CDamageScreen::Update(void)
{
	...
	RECT	rcDamageScreen = { long(m_fX - m_fSizeX * 0.5f)
...
void CDamageScreen::Render(void)
{
	if (m_fCount >= 1.f)
		return;
...
HRESULT CDamageScreen::AddComponent(void)
{
	...
	//Texture
	pComponent = m_pResourceMgr->CloneResource(RESOURCE_STAGE, L"DamageScreen");
...
CDamageScreen* CDamageScreen::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CDamageScreen*		pGameObject = new CDamageScreen(pDevice);
