...
CCromcruachHitBox::CCromcruachHitBox(LPDIRECT3DDEVICE9 pDevice)
...
CCromcruachHitBox::~CCromcruachHitBox(void)
{

}

HRESULT CCromcruachHitBox::Initialize(void)
{
...
void CCromcruachHitBox::SetColScale(D3DXVECTOR3 _vScale)
{
	m_pInfo->m_vScale = _vScale;
}

void CCromcruachHitBox::Update(void)
{
...
void CCromcruachHitBox::Render(void)
{
...
HRESULT CCromcruachHitBox::AddComponent(void)
{
...
CCromcruachHitBox * CCromcruachHitBox::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CCromcruachHitBox*		pGameObject = new CCromcruachHitBox(pDevice);
