...
// AnimationTool.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
// 유일한 CAnimationToolApp 개체입니다.

CAnimationToolApp theApp;


// CAnimationToolApp 초기화
...
int CAnimationToolApp::ExitInstance()
{
	...
	CAnimationMainApp::GetInstance()->DestroyInstance();

	return CWinAppEx::ExitInstance();
}

// CAnimationToolApp 메시지 처리기
...
BOOL CAnimationToolApp::OnIdle(LONG lCount)
{
	...
	{
		CAnimationMainApp::GetInstance()->Update();
		CAnimationMainApp::GetInstance()->Render();
	}
	return true;
}
